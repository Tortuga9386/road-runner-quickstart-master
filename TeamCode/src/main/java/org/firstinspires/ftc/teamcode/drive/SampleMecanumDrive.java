...
/*
 * Simple mecanum drive hardware implementation for robot hardware.
 */
@Config
public class SampleMecanumDrive extends MecanumDrive {
    ...
    public static double LATERAL_MULTIPLIER = 1.5057723289;
...
//        BNO055IMUUtil.remapAxes(imu, AxesOrder.XYZ, AxesSigns.NPN);
        ...
        leftRear = hardwareMap.get(DcMotorEx.class, "LeftRearWheel");
        rightRear = hardwareMap.get(DcMotorEx.class, "RightRearWheel");
        ...
        // TODO: Reverse any motors using DcMotor.setDirection() - should match RobotBase file
        leftFront.setDirection(DcMotor.Direction.REVERSE);
        leftRear.setDirection(DcMotor.Direction.REVERSE);

        // TODO: Use setLocalizer() to change the localization method
