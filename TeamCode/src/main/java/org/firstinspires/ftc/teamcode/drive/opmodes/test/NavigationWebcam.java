 ...
 * is explained below.
 */
@Autonomous(name = "Red Autonomous", group = "TestCode")
@Disabled
        ...
        if (opModeIsActive()) {
            while (opModeIsActive()) {
                if (tfod != null) {
                    ...
                    if (updatedRecognitions != null) {
                      ...
                      for (Recognition recognition : updatedRecognitions) {
                        fieldConfig = recognition.getLabel();
                        telemetry.addData(String.format("label (%d)", i), fieldConfig);
                ...
                if (actionComplete == true) {
                    telemetry.addData("Run Status: ", "Automated Actions Complete");
                    break;
                } else {
                    telemetry.addData("Run Status: ", "Evaluating Field Configuration");
                }
                telemetry.update();
                idle();
            } //Opmode loop
