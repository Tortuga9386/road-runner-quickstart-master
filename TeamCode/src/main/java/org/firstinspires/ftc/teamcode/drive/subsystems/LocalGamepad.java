...
public class LocalGamepad {
    ...
    public double XasCircle, YasCircle;

    public LocalGamepad(Gamepad gamepad) {
    ...
    public void update() {
        ...
        //https://amorten.com/blog/2017/mapping-square-input-to-circle-in-unity/
        XasCircle = gamepad.left_stick_x * Math.sqrt(1 - Math.pow(gamepad.left_stick_x,2) * 0.5f);
        YasCircle = gamepad.left_stick_y * Math.sqrt(1 - Math.pow(gamepad.left_stick_x,2) * 0.5f);
    }
}
